 ...
 */
this.PIXI = this.PIXI || {}, this.PIXI.sound = function(t, e, n, o) {
    "use strict";
    var i = function() {
            function t(t, e) {
    ...
    var h = function() {
        ...
        f = function(t) {
            function n(e) {
                ...
                return n.id = l++, n._media = null, n._paused = !1, n._muted = !1, n._elapsed = 0, n.init(e), n
            }
            return u(n, t), n.prototype.set = function(t, e) {
                ...
                if (this._source) {
                    ...
                    h.setParamValue(this._gain.gain, i * o * n), h.setParamValue(this._source.playbackRate, this._speed * e.speed * t.speed)
                }
            ...
            }, n.prototype._updateListener = function() {
                this._update()
        ...
        d = function(t) {
            ...
            return u(e, t), Object.defineProperty(e.prototype, "script", {
                get: function() {
                ...
                e.buffer = t.buffer, h.setParamValue(e.playbackRate, t.playbackRate.value), e.loop = t.loop;
        ...
        _ = function() {
            ...
            return t.prototype.init = function(t) {
                this.parent = t, this._nodes = new d(this.context), this._source = this._nodes.bufferSource, this.source = t.options.source
            }, t.prototype.destroy = function() {
        ...
        g = {
            ...
            EqualizerFilter: function(t) {
                function e(n, o, i, r, s, u, a, c, l, f) {
                    void 0 === n && (n = 0), void 0 === o && (o = 0), void 0 === i && (i = 0), void 0 === r && (r = 0), void 0 === s && (s = 0), void 0 === u && (u = 0), void 0 === a && (a = 0), void 0 === c && (c = 0), void 0 === l && (l = 0), void 0 === f && (f = 0);
                    var d = this;
                    if (!p().useLegacy) {
                        var _ = [{
                            f: e.F32,
                            ...
                            var e = p().context.audioContext.createBiquadFilter();
                            return e.type = t.type, h.setParamValue(e.Q, 1), e.frequency.value = t.f, h.setParamValue(e.gain, t.gain), e
                        });
                ...
                return u(e, t), e.prototype.setGain = function(t, e) {
                    if (void 0 === e && (e = 0), !this.bandsMap[t]) throw new Error("No band found for frequency " + t);
                    h.setParamValue(this.bandsMap[t].gain, e)
            ...
            DistortionFilter: function(t) {
                function e(e) {
                    ...
                    var n = this;
                    if (!p().useLegacy) {
                        var o = p().context.audioContext.createWaveShaper();
                        return (n = t.call(this, o) || this)._distortion = o, n.amount = e, n
                    }
                    n = t.call(this, null) || this
                }
                return u(e, t), Object.defineProperty(e.prototype, "amount", {
                    get: function() {
                        return this._amount
                    },
                    set: function(t) {
            ...
            StereoFilter: function(t) {
                function e(e) {
                    ...
                    var n = this;
                    if (!p().useLegacy) {
                        var o, i, r, s = p().context.audioContext;
                ...
                return u(e, t), Object.defineProperty(e.prototype, "pan", {
                    get: function() {
                        return this._pan
                    },
                    set: function(t) {
                        this._pan = t, this._stereo ? h.setParamValue(this._stereo.pan, t) : this._panner.setPosition(t, 0, 1 - Math.abs(t))
                    },
                    enumerable: !0,
                    configurable: !0
                }), e.prototype.destroy = function() {
            ...
            ReverbFilter: function(t) {
                function e(e, n, o) {
                    ...
                    var i = this;
                    if (!p().useLegacy) return (i = t.call(this, null) || this)._seconds = i._clamp(e, 1, 50), i._decay = i._clamp(n, 0, 100), i._reverse = o, i._rebuild(), i;
                    i = t.call(this, null) || this
                }
                return u(e, t), e.prototype._clamp = function(t, e, n) {
                    ...
                    for (var t, e = p().context.audioContext, n = e.sampleRate, o = n * this._seconds, i = e.createBuffer(2, o, n), r = i.getChannelData(0), s = i.getChannelData(1), u = 0; u < o; u++) t = this._reverse ? o - u : u, r[u] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay), s[u] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay);
                    var a = p().context.audioContext.createConvolver();
            ...
            TelephoneFilter: function(t) {
                function e() {
                    if (!p().useLegacy) {
                        var e = p().context.audioContext,
                            n = e.createBiquadFilter(),
                            o = e.createBiquadFilter(),
                            i = e.createBiquadFilter(),
                            r = e.createBiquadFilter();
                        return n.type = "lowpass", h.setParamValue(n.frequency, 2e3), o.type = "lowpass", h.setParamValue(o.frequency, 2e3), i.type = "highpass", h.setParamValue(i.frequency, 500), r.type = "highpass", h.setParamValue(r.frequency, 500), n.connect(o), o.connect(i), i.connect(r), t.call(this, n, r) || this
                    }
                    t.call(this, null)
                }
                return u(e, t), e
        ...
        v = function(t) {
            ...
            return u(n, t), n.prototype.set = function(t, e) {
                ...
                var o = this,
                    ...
                    a = t.volume,
                    c = t.muted;
                this._speed = s, this._volume = a, this._loop = !!u, this._muted = c, this.refresh(), this.loop && null !== r && (this.loop = !1), this._start = i, this._end = r || this._duration, this._start = Math.max(0, this._start - n.PADDING), this._end = Math.min(this._end + n.PADDING, this._duration), this._source.onloadedmetadata = function() {
                    o._source && (o._source.currentTime = i, o._source.onloadedmetadata = null, o.emit("progress", i, o._duration), e.Ticker.shared.add(o._onUpdate, o))
        ...
        x = function(t) {
            ...
            return u(e, t), e.prototype.refresh = function() {
                this.emit("refresh")
            }, e.prototype.refreshPaused = function() {
        ...
        j = ["mp3", "ogg", "oga", "opus", "mpeg", "wav", "m4a", "aiff", "wma", "mid"];
    var E, w, A, L, F = (E = {
            m4a: "mp4",
            oga: "ogg"
        }, w = document.createElement("audio"), A = {}, L = /^no$/, j.forEach(function(t) {
            var e = E[t] || t,
                n = w.canPlayType("audio/" + t).replace(L, ""),
                o = w.canPlayType("audio/" + e).replace(L, "");
            A[t] = !!n || !!o
        }), Object.freeze(A)),
        C = /\.(\{([^\}]+)\})(\?.*)?$/;
    ...
    var I = function() {
            ...
            return e.add = function() {
                ...
                t.data && j.indexOf(t.extension) > -1 ? t.sound = p().add(t.name, {
                    loaded: e,
                    preload: !0,
                    url: t.url,
                    source: t.data
        ...
        M = function() {
            ...
            return t.from = function(e) {
                var n = {};
                return "string" == typeof e ? n.url = e : e instanceof ArrayBuffer || e instanceof HTMLAudioElement ? n.source = e : n = e, (n = c({
                    autoPlay: !1,
                    singleInstance: !1,
                    url: null,
                    source: null,
                    ...
                    loaded: null,
                    loop: !1
                }, n)).url && (n.url = S(n.url)), Object.freeze(n), new t(p().useLegacy ? new P : new _, n)
            }, Object.defineProperty(t.prototype, "context", {
                get: function() {
                    return p().context
                },
        ...
        T = function() {
            ...
            return t.prototype.init = function() {
                return this.supported && (this._webAudioContext = new y), this._htmlAudioContext = new x, this._sounds = {}, this.useLegacy = !this.supported, this
            }, Object.defineProperty(t.prototype, "context", {
                get: function() {
                ...
                set: function(t) {
                    I.legacy = t, this._useLegacy = t, this._context = !t && this.supported ? this._webAudioContext : this._htmlAudioContext
                },
                enumerable: !0,
                configurable: !0
    ...
    var G = {
            ...
            render: function(t, e) {
                ...
                var i = o.BaseTexture.from(n);
                if (!(t.media instanceof _)) return i;
                var r = t.media,
                    s = n.getContext("2d");
                s.fillStyle = e.fill;
                for (var u = r.buffer.getChannelData(0), a = Math.ceil(u.length / e.width), p = e.height / 2, h = 0; h < e.width; h++) {
                    for (var l = 1, f = -1, d = 0; d < a; d++) {
                        var y = u[h * a + d];
                        y < l && (l = y), y > f && (f = y)
                    }
                    s.fillRect(h, (1 + l) * p, 1, Math.max(1, (f - l) * p))
                }
                return i
            },
            resolveUrl: S,
            sineTone: function(t, e) {
                ...
                if (!(n.media instanceof _)) return n;
    ...
    return t.Loader.registerPlugin(I), Object.defineProperties(K, {
        Filterable: {
            get: function() {
                return i
            }
