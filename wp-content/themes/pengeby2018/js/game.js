/* version 1.3 */
/* MODIFIED BY FuTTiiZ, 5th Feb 2025 */
  ...
  if (isMobile || isIPad) {
    if (window.innerHeight > window.innerWidth) {
      ...
      maskBottom.drawRect(
        ...
        gameBorder.height,
        window.innerWidth,
        window.innerHeight - gameBorder.height
      )
      ...
      $('#nameinput').css(
        'left',
        'calc(50% + ' + Math.floor(112 * mobileScale) + 'px)'
      )
      ...
      $('#monoinput').css(
        'left',
        Math.floor(520 * mobileScale + gameContainer.x) + 'px'
      )
      ...
      $('#mononameinput0').css(
        'left',
        'calc(50% - ' + Math.floor(106 * mobileScale) + 'px)'
      )
      $('#mononameinput1').css(
        'left',
        'calc(50% - ' + Math.floor(3 * mobileScale) + 'px)'
      )
      $('#mononameinput2').css(
        'left',
        'calc(50% - ' + Math.floor(135 * mobileScale) + 'px)'
      )
      $('#mononameinput3').css(
        'left',
        'calc(50% - ' + Math.floor(23 * mobileScale) + 'px)'
      )
      $('#mononameinput4').css(
        'left',
        'calc(50% + ' + Math.floor(87 * mobileScale) + 'px)'
      )
      $('#mononameinput5').css(
        'left',
        'calc(50% - ' + Math.floor(135 * mobileScale) + 'px)'
...
function loadPreloaderAssets() {
  ...
  preloaderLoader.add('images/loaderBGXL.png').add('images/loaderCow.json')
...
function loadUniverseResources(data) {
  ...
  PIXI.Loader.shared
    ...
    .add([
      'images/avatar/BoyFace0001.png',
      'images/avatar/BoyFace0002.png',
      'images/avatar/Dreng_bluse10001.png',
      'images/avatar/Dreng_bluse10002.png',
      'images/avatar/Dreng_bluse10003.png',
      'images/avatar/Dreng_bluse10004.png',
      'images/avatar/Dreng_bluse20001.png',
      'images/avatar/Dreng_bluse20002.png',
      'images/avatar/Dreng_bluse20003.png',
      'images/avatar/Dreng_bluse20004.png',
      'images/avatar/Dreng_bluse30001.png',
      'images/avatar/Dreng_bluse30002.png',
      'images/avatar/Dreng_bluse30003.png',
      'images/avatar/Dreng_bluse30004.png',
      'images/avatar/Dreng_bukser10001.png',
      'images/avatar/Dreng_bukser10002.png',
      'images/avatar/Dreng_bukser10003.png',
      'images/avatar/Dreng_bukser10004.png',
      'images/avatar/Dreng_bukser20001.png',
      'images/avatar/Dreng_bukser20002.png',
      'images/avatar/Dreng_bukser20003.png',
      'images/avatar/Dreng_bukser20004.png',
      'images/avatar/Dreng_bukser30001.png',
      'images/avatar/Dreng_bukser30002.png',
      'images/avatar/Dreng_bukser30003.png',
      'images/avatar/Dreng_bukser30004.png',
      'images/avatar/Dreng_haar10001.png',
      'images/avatar/Dreng_haar10002.png',
      'images/avatar/Dreng_haar10003.png',
      'images/avatar/Dreng_haar10004.png',
      'images/avatar/Dreng_haar20001.png',
      'images/avatar/Dreng_haar20002.png',
      'images/avatar/Dreng_haar20003.png',
      'images/avatar/Dreng_haar20004.png',
      'images/avatar/Dreng_haar30001.png',
      'images/avatar/Dreng_haar30002.png',
      'images/avatar/Dreng_haar30003.png',
      'images/avatar/Dreng_haar30004.png',
      'images/avatar/Dreng_haar40001.png',
      'images/avatar/Dreng_haar40002.png',
      'images/avatar/Dreng_haar40003.png',
      'images/avatar/Dreng_haar40004.png',
      'images/avatar/Dreng_oejne0001.png',
      'images/avatar/Dreng_oejne0002.png',
      'images/avatar/Dreng_oejne0003.png',
      'images/avatar/Dreng_sko10001.png',
      'images/avatar/Dreng_sko10002.png',
      'images/avatar/Dreng_sko10003.png',
      'images/avatar/Dreng_sko10004.png',
      'images/avatar/Dreng_sko20001.png',
      'images/avatar/Dreng_sko20002.png',
      'images/avatar/Dreng_sko20003.png',
      'images/avatar/Dreng_sko20004.png',
      'images/avatar/Dreng_sko30001.png',
      'images/avatar/Dreng_sko30002.png',
      'images/avatar/Dreng_sko30003.png',
      'images/avatar/Dreng_sko30004.png',
      'images/avatar/Krop_dreng0001.png',
      'images/avatar/Krop_dreng0002.png',
    ])
    .add([
      'images/avatar/GirlFace0001.png',
      'images/avatar/GirlFace0002.png',
      'images/avatar/Pige_bluse10001.png',
      'images/avatar/Pige_bluse10002.png',
      'images/avatar/Pige_bluse10003.png',
      'images/avatar/Pige_bluse10004.png',
      'images/avatar/Pige_bluse20001.png',
      'images/avatar/Pige_bluse20002.png',
      'images/avatar/Pige_bluse20003.png',
      'images/avatar/Pige_bluse20004.png',
      'images/avatar/Pige_bluse30001.png',
      'images/avatar/Pige_bluse30002.png',
      'images/avatar/Pige_bluse30003.png',
      'images/avatar/Pige_bluse30004.png',
      'images/avatar/Pige_bukser10001.png',
      'images/avatar/Pige_bukser10002.png',
      'images/avatar/Pige_bukser10003.png',
      'images/avatar/Pige_bukser10004.png',
      'images/avatar/Pige_bukser20001.png',
      'images/avatar/Pige_bukser20002.png',
      'images/avatar/Pige_bukser20003.png',
      'images/avatar/Pige_bukser20004.png',
      'images/avatar/Pige_bukser30001.png',
      'images/avatar/Pige_bukser30002.png',
      'images/avatar/Pige_bukser30003.png',
      'images/avatar/Pige_bukser30004.png',
      'images/avatar/Pige_haar10001.png',
      'images/avatar/Pige_haar10002.png',
      'images/avatar/Pige_haar10003.png',
      'images/avatar/Pige_haar10004.png',
      'images/avatar/Pige_haar20001.png',
      'images/avatar/Pige_haar20002.png',
      'images/avatar/Pige_haar20003.png',
      'images/avatar/Pige_haar20004.png',
      'images/avatar/Pige_haar30001.png',
      'images/avatar/Pige_haar30002.png',
      'images/avatar/Pige_haar30003.png',
      'images/avatar/Pige_haar30004.png',
      'images/avatar/Pige_haar40001.png',
      'images/avatar/Pige_haar40002.png',
      'images/avatar/Pige_haar40003.png',
      'images/avatar/Pige_haar40004.png',
      'images/avatar/Pige_oejne0001.png',
      'images/avatar/Pige_oejne0002.png',
      'images/avatar/Pige_oejne0003.png',
      'images/avatar/Pige_sko10001.png',
      'images/avatar/Pige_sko10002.png',
      'images/avatar/Pige_sko10003.png',
      'images/avatar/Pige_sko10004.png',
      'images/avatar/Pige_sko20001.png',
      'images/avatar/Pige_sko20002.png',
      'images/avatar/Pige_sko20003.png',
      'images/avatar/Pige_sko20004.png',
      'images/avatar/Pige_sko30001.png',
      'images/avatar/Pige_sko30002.png',
      'images/avatar/Pige_sko30003.png',
      'images/avatar/Pige_sko30004.png',
      'images/avatar/Krop_pige0001.png',
      'images/avatar/Krop_pige0002.png',
    ])
    .add([
      'images/universe/Universe-bg.png',
      'images/universe/Universe-middle.png',
      'images/universe/Universe-front.png',
    ])
...
function setupInterface() {
  if (topBar) {
    ...
    frontGround.logo.addChild(
      createSprite('images/universe/logo_' + language + '.png', 11, 3)
    )
    ...
    frontGround.subtitles.addChild(
      createSprite('images/universe/subtitlesBG.png', 0, 0)
    )

    frontGround.subtitlesLabel = new PIXI.Text(
      '',
      new PIXI.TextStyle({
        fontFamily: 'Arial',
        fontSize: 12,
    ...
    frontGround.subtitlesBtn.addChild(
      createSprite('images/universe/subtitlesBtn.png', 0, 0)
    )
    ...
    frontGround.subtitlesBtnLabel = new PIXI.Text(
      universeData.pengeby_subtitlesButtonOff.content,
      new PIXI.TextStyle({
        fontFamily: 'Arial',
        fontSize: 12,
        fill: 'white',
...
function toggleSubtitles() {
  if (frontGround.showSubtitles) {
    frontGround.showSubtitles = false
    frontGround.subtitlesBtnLabel.text =
      universeData.pengeby_subtitlesButtonOff.content
    ...
    frontGround.subtitlesBtnLabel.text =
      universeData.pengeby_subtitlesButtonOn.content
    ...
    for (var j = 0; j < relevantShopArray.length; j++) {
      if (itemName == relevantShopArray[j][0]) {
        ...
        if (itemType == 'item') {
          itemBtn.addChild(
            createMC(
              relevantShopArray[j][2],
              relevantShopArray[j][4],
              relevantShopArray[j][6],
              relevantShopArray[j][7]
            )
          )
        } else if (itemType == 'boyShoes') {
          itemBtn.addChild(
            createMC(relevantShopArray[j][2], relevantShopArray[j][4], 50, 70)
          )
          itemBtn.children[0].pivot.set(80, 55)
        } else if (itemType == 'boyLegs') {
          itemBtn.addChild(
            createMC(relevantShopArray[j][2], relevantShopArray[j][4], 50, 65)
          )
          itemBtn.children[0].pivot.set(67, 95)
        } else if (itemType == 'boyBody') {
          itemBtn.addChild(
            createMC(relevantShopArray[j][2], relevantShopArray[j][4], 50, 80)
          )
...
//SELECT  USER
function userSelect() {
  gameConfig.containerBG = createSprite(
    'images/universe/selectUserBG.png',
    -100,
    0
  )
...
function selectGender() {
  ...
  var genderSelectBG = createSprite(
    'images/chrCreate/genderSelect.png',
    300,
    60
  )
...
function selectLook() {
  ...
  if (user.gender == 'boy') {
    var dressRoomBG = createSprite(
      'images/chrCreate/BoyDressRoom.png',
      160,
      200
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('ht1', 202, 232, selectHairType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('ht2', 263, 221, selectHairType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('ht3', 325, 225, selectHairType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('ht4', 380, 241, selectHairType)
    )

    //hairColor
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('1', 213, 294, true, selectHairColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('2', 258, 294, false, selectHairColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('3', 303, 294, false, selectHairColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('4', 348, 294, false, selectHairColor)
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('bt1', 195, 405, selectBodyType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('bt2', 252, 405, selectBodyType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('bt3', 309, 405, selectBodyType)
    )

    //body color
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('bc1', 193, 461, true, selectBodyColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('bc2', 238, 461, false, selectBodyColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('bc3', 283, 461, false, selectBodyColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('bc4', 328, 461, false, selectBodyColor)
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('st1', 300, 536, selectShoesType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('st2', 331, 536, selectShoesType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('st3', 375, 536, selectShoesType)
    )

    //shoes color
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('sc1', 270, 585, true, selectShoesColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('sc2', 315, 585, false, selectShoesColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('sc3', 360, 585, false, selectShoesColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('sc4', 405, 585, false, selectShoesColor)
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('et1', 644, 344, selectEyesType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('et2', 700, 320, selectEyesType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('et3', 747, 341, selectEyesType)
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('lt1', 634, 516, selectLegsType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('lt2', 688, 505, selectLegsType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('lt3', 740, 510, selectLegsType)
    )

    //legs color
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('lc1', 629, 571, true, selectLegsColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('lc2', 674, 571, false, selectLegsColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('lc3', 717, 571, false, selectLegsColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('lc4', 760, 571, false, selectLegsColor)
    )

    //skin
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('01', 691, 391, true, selectSkin)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('02', 736, 391, false, selectSkin)
    )
  } else {
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('ht1', 192, 237, selectHairType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('ht2', 253, 217, selectHairType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('ht3', 315, 225, selectHairType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('ht4', 365, 241, selectHairType)
    )

    //hairColor
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('1', 203, 300, true, selectHairColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('2', 248, 300, false, selectHairColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('3', 293, 300, false, selectHairColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('4', 338, 300, false, selectHairColor)
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('bt1', 185, 395, selectBodyType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('bt2', 242, 395, selectBodyType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('bt3', 299, 395, selectBodyType)
    )

    //body color
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('bc1', 193, 455, true, selectBodyColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('bc2', 236, 455, false, selectBodyColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('bc3', 281, 455, false, selectBodyColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('bc4', 325, 455, false, selectBodyColor)
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('st1', 280, 526, selectShoesType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('st2', 331, 526, selectShoesType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('st3', 380, 526, selectShoesType)
    )

    //shoes color
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('sc1', 270, 580, true, selectShoesColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('sc2', 315, 580, false, selectShoesColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('sc3', 360, 580, false, selectShoesColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('sc4', 405, 580, false, selectShoesColor)
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('et1', 644, 340, selectEyesType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('et2', 694, 315, selectEyesType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('et3', 742, 331, selectEyesType)
    )
    ...
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('lt1', 624, 498, selectLegsType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('lt2', 678, 495, selectLegsType)
    )
    dressRoomContainer.addChild(
      createDressRoomAlphaBtn('lt3', 728, 500, selectLegsType)
    )

    //legs color
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('lc1', 619, 568, true, selectLegsColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('lc2', 660, 568, false, selectLegsColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('lc3', 704, 568, false, selectLegsColor)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('lc4', 748, 568, false, selectLegsColor)
    )

    //skin
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('01', 691, 387, true, selectSkin)
    )
    dressRoomContainer.addChild(
      createDressRoomSquareBtn('02', 736, 387, false, selectSkin)
    )
  }
...
function drawAvatar() {
  ...
  if (user.gender == 'boy') {
    avatar.addChild(
      createSprite('images/avatar/Krop_dreng00' + user.skin + '.png', 0, 100)
    )
    ...
    avatar.addChild(
      createSprite('images/avatar/BoyFace00' + user.skin + '.png', 10, 0)
    )

    avatar.addChild(
      createSprite('images/avatar/Dreng_oejne00' + user.eyes + '.png', 30, 53)
    )

    if (user.hair == 3) {
      avatar.addChild(
        createSprite(
          'images/avatar/Dreng_haar' +
            user.hair +
            '000' +
            user.hairColor +
            '.png',
    ...
    avatar.addChild(
      createSprite('images/avatar/Krop_pige00' + user.skin + '.png', 0, 100)
    )
    ...
    avatar.addChild(
      createSprite('images/avatar/GirlFace00' + user.skin + '.png', 10, 0)
    )

    avatar.addChild(
      createSprite('images/avatar/Pige_oejne00' + user.eyes + '.png', 16, 55)
    )

    if (user.hair == 3) {
      avatar.addChild(
        createSprite(
          'images/avatar/Pige_haar' +
            user.hair +
            '000' +
            user.hairColor +
            '.png',
...
function initUniverse() {
  ...
  frontGround.avatarBG = createSprite(
    'images/universe/ToolbarAvatarBG.png',
    0,
    475
  )
  ...
  frontGround.goldTF = new PIXI.Text(
    gold,
    new PIXI.TextStyle({
      fontFamily: 'Arial',
      fontSize: 35,
  ...
  frontGround.silverTF = new PIXI.Text(
    silver,
    new PIXI.TextStyle({
      fontFamily: 'Arial',
      fontSize: 35,
...
function playAmbientSounds() {
  var birdSound =
    PIXI.Loader.shared.resources['bird' + Math.ceil(Math.random() * 4)].sound
  birdSound.volume = 0.1
  birdSound.play()
  var waterSound =
    PIXI.Loader.shared.resources['water' + Math.ceil(Math.random() * 3)].sound
  ...
  if (universeContainer) {
    ...
    if (user.wizardDone) {
      if (user.treasureFound) {
        ...
        if (universeContainer.treasure) {
        } else {
          universeContainer.treasure = createSprite(
            'images/universe/GoldButton.png',
            400,
            580
          )
    ...
    var universeMiddle = createSprite(
      'images/universe/Universe-middle.png',
      -60,
      91
    )
    ...
    var universeFront = createSprite(
      'images/universe/Universe-front.png',
      120,
      208
    )
    ...
    if (wizardGame) {
      universeContainer.setChildIndex(
        wizardGame,
        universeContainer.children.length - 1
      )
    }
...
function backToUniverse() {
  ...
  if (gameConfig.appleKeysSetup) {
    //apple game keylisteners running
  ...
  if (localTest) {
    loadRoomResources({
      speak_b_room_welcome: {
        ...
        subtitle:
          'Velkommen til dit v\u00e6relse. Hvis du har lyst til at skifte t\u00f8j, skal du bare klikke p\u00e5 skabet. Husk, at du kan k\u00f8be mere t\u00f8j og flere ting til dit v\u00e6relse i Karens Butik. Hvis du har v\u00e6ret ude at rejse med Tidsmaskinen, kan du ovre p\u00e5 hylden se de ting, du har f\u00e5et. Og hvis Troldmanden har fortalt dig sin hemmelighed, h\u00e6nger dit diplom p\u00e5 tavlen. Klik p\u00e5 kortet for at g\u00e5 p\u00e5 opdagelse i Pengeby! ',
      },
    })
  } else {
    $.ajax({
...
function initRoom(loader, resources) {
  ...
  if (user.wizardDone) {
    var diploma = createSprite(
      'images/room/roomDiploma.png',
      200,
      80,
      gameLoader
    )
...
function addRoomItem(itemArray, itemX, itemY) {
  ...
  itemBtn.addChild(
    createMC(itemArray[2], itemArray[4], itemArray[6], itemArray[7])
  )
  itemBtn.x = itemX
  itemBtn.y = itemY
...
function initRoomItemDrag(event) {
  if (this.isAnim && !this.animPlayed) {
    ...
    this.on('pointerup', onRoomItemDragEnd)
...
function onRoomItemDragEnd() {
  ...
  this.off('pointerup', onRoomItemDragEnd)
...
function showCloset() {
  ...
  gameConfig.closetBG = createSprite(
    'images/room/closetBG.png',
    18,
    -30,
    gameLoader
  )
  ...
  if (user.gender == 'boy') {
    ...
    for (var i = 0; i < user.inventory.length; i++) {
      if (user.inventory[i].indexOf('origshoes') != -1) {
        if (user.inventory[i].split('_')[1] == '1') {
          var closetItem = createSprite(
            'images/avatar/Dreng_sko1000' + user.shoesColor + '.png',
            200,
            435
          )
          ...
          closetItem = createSprite(
            'images/avatar/Dreng_sko2000' + user.shoesColor + '.png',
            200,
            43
          )
          closetItem.type = 'boyshoe'
          ...
          closetItem = createSprite(
            'images/avatar/Dreng_sko3000' + user.shoesColor + '.png',
            200,
            435
          )
          closetItem.type = 'boyshoe'
    ...
    for (var i = 0; i < user.inventory.length; i++) {
      if (user.inventory[i].indexOf('origlegs') != -1) {
        if (user.inventory[i].split('_')[1] == '1') {
          ...
          closetItem.y = 150
          closetItem.addChild(
            createSprite('images/room/hanger.png', 35, -28, gameLoader)
          )
          closetItem.addChild(
            createSprite(
              'images/avatar/Dreng_bukser1000' + user.legsColor + '.png',
              0,
              0
            )
          )
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Dreng_bukser2000' + user.legsColor + '.png',
              0,
              0
            )
          )
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Dreng_bukser3000' + user.legsColor + '.png',
              0,
              0
            )
          )
    ...
    for (var i = 0; i < user.inventory.length; i++) {
      if (user.inventory[i].indexOf('origbody') != -1) {
        if (user.inventory[i].split('_')[1] == '1') {
          ...
          closetItem.y = 140
          closetItem.addChild(
            createSprite('images/room/hanger.png', 35, -18, gameLoader)
          )
          closetItem.addChild(
            createSprite(
              'images/avatar/Dreng_bluse1000' + user.bodyColor + '.png',
              0,
              0
            )
          )
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Dreng_bluse2000' + user.bodyColor + '.png',
              0,
              0
            )
          )
          ...
          closetItem.frame = 2
          makeButton(closetItem, selectClosetItem)
          gameConfig.closetContainer.addChild(
            createSprite(
              'images/room/hanger.png',
              235 + hangerCount * 150,
              122,
              gameLoader
            )
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Dreng_bluse3000' + user.bodyColor + '.png',
              0,
              0
            )
          )
    ...
    //girl_______________________________________________________
    var shoeCount = 0
    gameConfig.closetShoeArray = new Array()
    for (var i = 0; i < user.inventory.length; i++) {
      if (user.inventory[i].indexOf('origshoes') != -1) {
        if (user.inventory[i].split('_')[1] == '1') {
          var closetItem = createSprite(
            'images/avatar/Pige_sko1000' + user.shoesColor + '.png',
            200,
            435
          )
          ...
          closetItem = createSprite(
            'images/avatar/Pige_sko2000' + user.shoesColor + '.png',
            200,
            435
          )
          closetItem.type = 'girlshoe'
          ...
          closetItem = createSprite(
            'images/avatar/Pige_sko3000' + user.shoesColor + '.png',
            200,
            435
          )
          closetItem.type = 'girlshoe'
    ...
    for (var i = 0; i < user.inventory.length; i++) {
      if (user.inventory[i].indexOf('origlegs') != -1) {
        if (user.inventory[i].split('_')[1] == '1') {
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Pige_bukser1000' + user.legsColor + '.png',
              0,
              0
            )
          )
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Pige_bukser2000' + user.legsColor + '.png',
              0,
              0
            )
          )
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Pige_bukser3000' + user.legsColor + '.png',
              0,
              0
            )
          )
    ...
    for (var i = 0; i < user.inventory.length; i++) {
      if (user.inventory[i].indexOf('origbody') != -1) {
        if (user.inventory[i].split('_')[1] == '1') {
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Pige_bluse1000' + user.bodyColor + '.png',
              0,
              0
            )
          )
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Pige_bluse2000' + user.bodyColor + '.png',
              0,
              0
            )
          )
          ...
          closetItem.addChild(
            createSprite(
              'images/avatar/Pige_bluse3000' + user.bodyColor + '.png',
              0,
              0
            )
          )
  ...
  if (gameConfig.closetClothesArray.length > 5) {
    gameConfig.closetClothesNextArrow = createSprite(
      'images/room/closetArrow.png',
      950,
      150,
      gameLoader
    )
    ...
    gameConfig.closetClothesPrevArrow = createSprite(
      'images/room/closetArrow.png',
      100,
      150,
      gameLoader
  ...
  if (gameConfig.closetShoeArray.length > 5) {
    gameConfig.closetShoesNextArrow = createSprite(
      'images/room/closetArrow.png',
      950,
      450,
      gameLoader
    ...
    gameConfig.closetShoesPrevArrow = createSprite(
      'images/room/closetArrow.png',
      100,
      450,
      gameLoader
  ...
  if (localTest) {
    loadKarensResources({
      speak_b_karens_welcome: {
        ...
        subtitle:
          'Nu er du p\u00e5 vej ind i Karens butik. Her kan du k\u00f8be en masse t\u00f8j og ting til dit v\u00e6relse for dine penge. Klik p\u00e5 de ting, du gerne vil k\u00f8be! Hvis du ikke har penge nok til dem, kan du altid komme dem i din \u00f8nskekrukke, s\u00e5 du kan spare op til dem. Tryk p\u00e5 den gr\u00f8nne knap for at komme ind i butikken.',
      },
      ...
      speak_karens_buy1: {
        ...
        subtitle:
          'Den er fin! Hvor mange penge har du tilbage, hvis du k\u00f8ber den?',
      },
      speak_karens_buy2: {
        contenttype: 'sound',
      ...
      speak_karens_intro: {
        ...
        subtitle:
          'Er der nogle ting, du godt kunne t\u00e6nke dig i min butik?',
      },
      speak_karens_wishlist: {
        contenttype: 'sound',
        content: 'dk_ikke_raad_til_vare.mp3',
        subtitle:
          'Den har du desv\u00e6rre ikke penge nok til at k\u00f8be! Men du kan komme den i \u00f8nskekrukken, hvis du gerne vil spare op til den. Hvor mange penge mangler du?',
      },
...
var shopItemPositions = new Array(
  [680, 70],
  [800, 70],
  [680, 185],
  [780, 185],
...
function initKarens(loader, resources) {
  ...
  for (var i = 0; i < 2; i++) {
    ...
    shoeBtn.addChild(
      createMC(randomArray[i][2], randomArray[i][4], 220 + i * 150, 315)
    )
...
function doWish() {
  if (user.wishlist.length >= 3) {
    ...
    user.wishlist.push([
      gameConfig.selectedItem.name,
      gameConfig.selectedItem.price,
    ])
  ...
  if (localTest) {
    loadTMReseources({
      speak_b_timemachine_welcome: {
        ...
        subtitle:
          'Velkommen til Tidsmaskinen. Her kan du rejse tilbage i tiden og pr\u00f8ve en masse sjove og sp\u00e6ndende ting - men kun, hvis du har penge nok. Det koster nemlig en guldm\u00f8nt, hver gang du rejser. Klik p\u00e5 den gr\u00f8nne knap for at v\u00e6lge, hvor du gerne vil rejse hen.',
      },
      speak_timemachine_nocash: {
        contenttype: 'sound',
        content: 'dk_ikke_raad.mp3',
        subtitle:
          'Det har du desv\u00e6rre ikke r\u00e5d til, s\u00e5 du m\u00e5 ud og tjene nogle penge!',
      },
      ...
      speak_timemachine_rome: {
        ...
        subtitle:
          'Det her er rejsen til det gamle Rom. Her kan du hj\u00e6lpe med at bygge flotte og store bygninger.',
      },
      speak_timemachine_dino: {
        contenttype: 'sound',
        content: 'dk_forklaring_paa_dinosaur.mp3',
        subtitle:
          'Her kan du rejse tilbage til dengang, hvor der fandtes dinosaurusser og hj\u00e6lpe med at finde dinosaurus \u00e6g.',
      },
      speak_timemachine_ridder: {
        contenttype: 'sound',
        content: 'dk_forklaringp_paa_riddertiden.mp3',
        subtitle:
          'Her kan du rejse tilbage til Riddertiden og pr\u00f8ve at k\u00e6mpe som en ridder.',
      },
      speak_timemachine_egypt: {
        contenttype: 'sound',
        content: 'dk_forklaring_paa_aegypten.mp3',
        subtitle:
          'Det her er rejsen til det gamle Egypten. Her er de i gang med at bygge verdens st\u00f8rste pyramide, og du kan hj\u00e6lpe med at indrette den.',
      },
...
function loadTMReseources(data) {
  ...
  gameLoader
    .add('images/timemachine/tmBG.png')
...
function skipTMIntro() {
  ...
  gameConfig.dinoBtnSun = createSprite(
    'images/timemachine/Solstraaler.png',
    58,
    50,
    gameLoader
  )
  ...
  gameConfig.dinoBtnNoHover = createSprite(
    'images/timemachine/screenDino.png',
    17,
    20,
    gameLoader
  )
  ...
  gameConfig.dinoBtnHover = createSprite(
    'images/timemachine/screenDinoHover.png',
    17,
    30,
    gameLoader
  )
  ...
  gameConfig.dinoBtnFG = createSprite(
    'images/timemachine/screenFG.png',
    28,
    21,
    gameLoader
  )
  ...
  gameConfig.egyptBtnSun = createSprite(
    'images/timemachine/Solstraaler.png',
    58,
    50,
    gameLoader
  ...
  gameConfig.egyptBtnNoHover = createSprite(
    'images/timemachine/screenEgypt.png',
    25,
    23,
    gameLoader
  )
  ...
  gameConfig.egyptBtnHover = createSprite(
    'images/timemachine/screenEgyptHover.png',
    25,
    22,
    gameLoader
  )
  ...
  gameConfig.egyptBtnFG = createSprite(
    'images/timemachine/screenFG.png',
    28,
    21,
    gameLoader
  ...
  gameConfig.romeBtnSun = createSprite(
    'images/timemachine/Solstraaler.png',
    58,
    50,
    gameLoader
  ...
  gameConfig.romeBtnNoHover = createSprite(
    'images/timemachine/screenRome.png',
    17,
    23,
    gameLoader
  )
  ...
  gameConfig.romeBtnHover = createSprite(
    'images/timemachine/screenRomeHover.png',
    17,
    23,
    gameLoader
  )
  ...
  gameConfig.romeBtnFG = createSprite(
    'images/timemachine/screenFG.png',
    28,
    21,
    gameLoader
  ...
  gameConfig.ridderBtnSun = createSprite(
    'images/timemachine/Solstraaler.png',
    58,
    50,
    gameLoader
  ...
  gameConfig.ridderBtnNoHover = createSprite(
    'images/timemachine/screenRidder.png',
    17,
    25,
    gameLoader
  )
  ...
  gameConfig.ridderBtnHover = createSprite(
    'images/timemachine/screenRidderHover.png',
    17,
    25,
    gameLoader
  )
  ...
  gameConfig.ridderBtnFG = createSprite(
    'images/timemachine/screenFG.png',
    28,
    21,
    gameLoader
...
function playChr() {
  if (gameConfig.currentChrSound) {
    if (gameConfig.currentChrSound[1] == undefined) {
      ...
      gameConfig.chrSound = playSound(
        gameConfig.currentChrSound[0],
        gameConfig.currentChrSound[1]
      )
    }
  ...
  if (localTest) {
    loadDinoReseources({
      speak_b_dino_loose1: {
        ...
        subtitle:
          'Ej, du n\u00e5ede at miste alle dine liv, f\u00f8r du fik fat i \u00e6ggene. Pr\u00f8v igen.',
      },
      speak_b_dino_loose2: {
        contenttype: 'sound',
        content: 'dk_spil_slut_tapt_2.mp3',
        subtitle:
          'Det var \u00e6rgerligt - du har ikke flere fors\u00f8g til at finde \u00e6ggene. M\u00e5ske skal du passe lidt bedre p\u00e5 n\u00e6ste gang? Pr\u00f8v igen for at se, om du kan g\u00f8re det bedre!',
      },
      speak_b_dino_welcome: {
        contenttype: 'sound',
        content: 'dk_velkomst_og_forklaring_dinosaurus.mp3',
        subtitle:
          'Nu har du rejst meget langt tilbage i tiden, nemlig til dengang, hvor der fandtes dinosaurusser. Dinosarus mor er blevet ked af det, fordi hun har mistet sine \u00e6g, og du skal derfor hj\u00e6lpe med at finde dem. For at finde \u00e6ggene skal du bruge pilene p\u00e5 tastaturet og grave dig ned igennem jorden. Du skal samle alle hjerterne, f\u00f8r du kan f\u00e5 fat i et \u00e6g. Men pas p\u00e5 de farlige ting undervejs - og skynd dig alt, hvad du kan! Tryk p\u00e5 den gr\u00f8nne knap, n\u00e5r du er klar.',
      },
      speak_b_dino_won1: {
        contenttype: 'sound',
        content: 'dk_spil_slut_gennemfoert_1.mp3',
        subtitle:
          'Du fandt alle \u00e6ggene - godt g\u00e5et! Pr\u00f8v at se, om du kan g\u00f8re det endnu hurtigere!',
      },
      speak_b_dino_won2: {
        contenttype: 'sound',
        content: 'dk_spil_slut_gennemfoert_2.mp3',
        subtitle:
          'Det er du god til - du fandt alle \u00e6ggene! Tror du, at du kan g\u00f8re det endnu hurtigere?',
      },
      dino_ambient: {
        contenttype: 'sound',
...
function loadDinoReseources(data) {
  ...
  gameLoader
    .add('images/dino/dinogameBG.png')
...
function initDino(loader, resources) {
  ...
  gameConfig.gameBar.life1 = createSprite(
    'images/dino/Figur_point.png',
    658,
    84,
    gameLoader
  )
  gameConfig.gameBar.addChild(gameConfig.gameBar.life1)
  gameConfig.gameBar.life2 = createSprite(
    'images/dino/Figur_point.png',
    686,
    74,
    gameLoader
  ...
  gameConfig.gameBar.life3 = createSprite(
    'images/dino/Figur_point.png',
    716,
    64,
    gameLoader
  ...
  gameConfig.gameBar.egg1 = createSprite(
    'images/dino/Aeg.png',
    284,
    78,
    gameLoader
  ...
  gameConfig.gameBar.egg2 = createSprite(
    'images/dino/Aeg.png',
    309,
    88,
    gameLoader
  ...
  gameConfig.gameBar.egg3 = createSprite(
    'images/dino/Aeg.png',
    334,
    98,
    gameLoader
  ...
  gameConfig.gameBar.egg4 = createSprite(
    'images/dino/Aeg.png',
    359,
    106,
    gameLoader
  ...
  gameConfig.gameBar.egg5 = createSprite(
    'images/dino/Aeg.png',
    384,
    108,
    gameLoader
...
function initDinoMobileControls() {
  if (gameConfig.mobileLeftBtn) {
    ...
    gameConfig.mobileLeftBtn = createSprite(
      'images/dino/mobileLeftBtn.png',
      60,
      630,
      gameLoader
    )
    ...
    gameConfig.mobileRightBtn = createSprite(
      'images/dino/mobileRightBtn.png',
      174,
      630,
      gameLoader
    )
    ...
    gameConfig.mobileUpBtn = createSprite(
      'images/dino/mobileUpBtn.png',
      117,
      573,
      gameLoader
    )
    ...
    gameConfig.mobileDownBtn = createSprite(
      'images/dino/mobileDownBtn.png',
      117,
      630,
      gameLoader
    )
        ...
        for (var i = 0; i < gameConfig.gameHolder.children.length; i++) {
          if (gameConfig.gameHolder.children[i].name == 'stone') {
            ...
            if (stone.x == x * 50 + 3 && stone.y == y * 50 + 2) {
              ...
              gameConfig.gameHolder.setChildIndex(
                stone,
                gameConfig.gameHolder.children.length - 1
              )
...
function checkIfTileIsTunneled(xPos, yPos) {
  for (var i = 0; i < gameConfig.tunnelArray.length; i++) {
    if (
      gameConfig.tunnelArray[i][0] == xPos &&
      gameConfig.tunnelArray[i][1] == yPos
    ) {
      return true
    }
  }
...
function updatePlayer() {
  ...
  var tile = createMCGC(
    'tunnel_tile00',
    35,
    gameConfig.player.posX * 50,
    gameConfig.player.posY * 50
  )
  tile.loop = false
  gameConfig.gameHolder.addChild(tile)
  cleanUpArray.push(tile)
  ...
  if (localTest) {
    loadEgyptReseources({
      speak_b_egypt_welcome: {
        ...
        subtitle:
          'Nu er du tilbage i det gamle Egypten, hvor de er i gang med at bygge verdens st\u00f8rste pyramide, som hedder Keops pyramiden. Du skal hj\u00e6lpe med at g\u00f8re det store rum til faraoen, som er en slags konge, rigtig flot! Du kan male v\u00e6ggen og dekorere den med flotte ting. Tryk p\u00e5 den gr\u00f8nne knap, n\u00e5r du er klar!',
      },
      egypt_ambient: {
        contenttype: 'sound',
...
function loadEgyptReseources(data) {
  ...
  gameLoader
    .add('images/egypt/EgyptGameBG.png')
...
function initEgypt(loader, resources) {
  ...
  var egyptBG = createSprite(
    'images/egypt/EgyptGameBG.png',
    -52,
    -5,
    gameLoader
  )
  ...
  if (isMobile || isIPad) {
    var bg = createSprite(
      'images/egypt/egyptIntroMobileBG.png',
      0,
      0,
      gameLoader
    )
    ...
    gameConfig.introVideo.addEventListener(
      'playing',
      stopEgyptIntroVideo,
      false
    )
...
function selectBrushColor() {
  ...
  gameContainer.setChildIndex(
    gameConfig.brush,
    gameContainer.children.length - 1
  )
...
function createDecorSprite(index, jarIndex, resourceName, textureName) {
  var decorSprite = new PIXI.Sprite(
    gameLoader.resources[resourceName].textures[textureName]
  )
  ...
  decorSprite.on('pointerdown', onDecorDragStart)
...
function openJar() {
  ...
  if (this.name == '1') {
    for (var i = 1; i < gameConfig.jar1Pos.length; i++) {
      var sheetItem = createDecorSprite(
        i,
        '1',
        'images/egypt/symbols_one_sheet.json',
        'symbols_one_' + i + '0000'
      )
    ...
    for (i = 1; i < gameConfig.jar2Pos.length; i++) {
      sheetItem = createDecorSprite(
        i,
        '2',
        'images/egypt/Symbol_two_sheet.json',
        'symbol_two_' + i + '0000'
      )
      cleanUpArray.push(sheetItem)
      gameConfig.paintArea.addChild(sheetItem)
    ...
    for (i = 1; i < gameConfig.jar3Pos.length; i++) {
      sheetItem = createDecorSprite(
        i,
        '3',
        'images/egypt/symbol_three_sheet.json',
        'symbol_three_' + i + '0000'
      )
      cleanUpArray.push(sheetItem)
      gameConfig.paintArea.addChild(sheetItem)
    }
...
function onDecorDragStart(event) {
  if (gameConfig.isPainting && this.y >= 100) {
    ...
    this.filters = [
      new PIXI.filters.ColorReplaceFilter(
        toReplace,
        toReplaceWith,
        replaceFactor
      ),
    ...
    this.on('pointerup', onDecorDragEnd)
...
function onDecorDragEnd() {
  ...
  this.off('pointerup', onDecorDragEnd)
  ...
  if (localTest) {
    loadRomeReseources({
      speak_b_rome_complete: {
        ...
        subtitle:
          'Det var du god til! Synes du ikke, at den er blevet flot? Det synes jeg, den er.',
      },
      speak_b_rome_startPuzzle: {
        contenttype: 'sound',
        content: 'dk_velkomst_og_forklaring_rom_0.mp3',
        subtitle:
          'Du skal tr\u00e6kke brikkerne med musen over p\u00e5 det rigtige sted p\u00e5 tegningen. N\u00e5r du har sat alle brikkerne rigtig, er du f\u00e6rdig. Tryk p\u00e5 den gr\u00f8nne knap, n\u00e5r du er klar til at bygge.',
      },
      speak_b_rome_welcome: {
        contenttype: 'sound',
        content: 'dk_velkomst_og_forklaring_rom.mp3',
        subtitle:
          'Velkommen tilbage til det gamle Rom. Her skal du hj\u00e6lpe med at bygge flotte bygninger! Du kan v\u00e6lge imellem tre forskellige bygninger - den f\u00f8rste er den nemmeste, og den sidste er den sv\u00e6reste.',
      },
      rome_ambient: {
        contenttype: 'sound',
...
function loadRomeReseources(data) {
  ...
  gameLoader
    .add('images/rome/RomeGameBG.png')
...
function initRome(loader, resources) {
  ...
  var navScreen = createSprite(
    'images/rome/NavigationScreen.png',
    790,
    120,
    gameLoader
  )
  ...
  gameConfig.pieces1Init = new Array(
    [202, 21],
    [536, 525],
    [142, 141],
    [514, 6],
  ...
  gameConfig.pieces2Init = new Array(
    [114, 11],
    [649, 514],
    [142, 141],
    [597, 5],
  ...
  gameConfig.pieces3Init = new Array(
    [270, 21],
    [536, 525],
    [107, 20],
    [724, 27],
...
function openPuzzle() {
  ...
  var introBG = createSprite(
    'images/rome/puzzle' + this.name + 'IntroBG.png',
    0,
    0,
    gameLoader
  )
...
function startPuzzle() {
  var puzzleBG = createSprite(
    'images/rome/puzzle' + gameConfig.currentPuzzle + 'BG.png',
    250,
    100,
    gameLoader
  )
  ...
  if (gameConfig.currentPuzzle == '1') {
    for (var i = 0; i < gameConfig.pieces1.length; i++) {
      var piece = new PIXI.Sprite(
        gameLoader.resources['images/rome/puzzle1Sheet.json'].textures[
          'P' + (i + 1) + '0000'
        ]
      )
      ...
      piece.on('pointerdown', onPieceDragStart)
    ...
    for (var i = 0; i < gameConfig.pieces2.length; i++) {
      var piece = new PIXI.Sprite(
        gameLoader.resources['images/rome/puzzle2Sheet.json'].textures[
          'C' + (i + 1) + '0000'
        ]
      )
    ...
    for (var i = 0; i < gameConfig.pieces3.length; i++) {
      var piece = new PIXI.Sprite(
        gameLoader.resources['images/rome/puzzle3Sheet.json'].textures[
          'R' + (i + 1) + '_Rome0000'
        ]
      )
...
function onPieceDragStart(event) {
  ...
  this.on('pointerup', onPieceDragEnd)
...
function onPieceDragEnd() {
  ...
  this.off('pointerup', onPieceDragEnd)
...
function puzzleFinished() {
  ...
  var endBG = createSprite(
    'images/rome/puzzle' + gameConfig.currentPuzzle + 'End.png',
    0,
    0,
    gameLoader
  )
  ...
  if (localTest) {
    loadRidderReseources({
      speak_b_ridder_complete: {
        ...
        subtitle:
          'Det er du god til! Pr\u00f8v igen for at se, om du kan g\u00f8re det bedre.',
      },
      speak_b_ridder_welcome: {
        contenttype: 'sound',
        content: 'velkommen_ridder_se.mp3',
        subtitle:
          'Nu har du rejst tilbage til middelalderen, og her skal du bruge en armbr\u00f8st for at skyde pile efter en m\u00e5lskive. Du skal trykke p\u00e5 de brune pile p\u00e5 armbr\u00f8sten for at bestemme, hvilken retning du vil skyde. Og du skal ogs\u00e5 indstille hvor h\u00e5rdt. N\u00e5r du tror, at du vil skyde h\u00e5rdt nok og i den rigtige retning til at ramme m\u00e5lskiven, skal du trykke p\u00e5 den gr\u00f8nne knap for at skyde. Pr\u00f8v og se, hvor mange point du kan f\u00e5! Tryk p\u00e5 den gr\u00f8nne knap for at g\u00e5 i gang!',
      },
      ridder_hit: {
        contenttype: 'sound',
...
function loadRidderReseources(data) {
  ...
  gameLoader
    .add('images/ridder/arrowBtns.json')
...
function initRidder(loader, resources) {
  ...
  gameConfig.gameBG.addChild(
    createSprite('images/ridder/RidderGameBG1.png', -50, -2, gameLoader)
  )
  ...
  var bundBarBG = createSprite(
    'images/ridder/Bundbar_aaben.png',
    -10,
    535,
    gameLoader
  )
  ...
  var popupBG = createSprite(
    'images/ridder/Start_ridderBG.png',
    0,
    0,
    gameLoader
  )
...
function startRotationLeft() {
  app.ticker.add(rotateBowLeft)
}

function endRotationLeft() {
  app.ticker.remove(rotateBowLeft)
}
...
function startRotationRight() {
  app.ticker.add(rotateBowRight)
}

function endRotationRight() {
  app.ticker.remove(rotateBowRight)
}
...
function showHitScreen() {
  ...
  var a = Math.abs(
    gameConfig.target.x + gameConfig.target.width / 2 - gameConfig.bow.x
  )
  ...
  var precision = Math.abs(
    win_angle - gameConfig.bow.rotation * (180 / Math.PI)
  )

  var hit_factor = Math.round(precision + 0.25)
  var power_failure =
    Math.abs(gameConfig.bow.power - (gameConfig.level - 1)) * 4
  ...
  if (gameConfig.hitScreen) {
    ...
    var hitscreenSprite = createSprite(
      'images/ridder/hit_screen.png',
      0,
      0,
      gameLoader
    )
...
function nextArrow() {
  ...
  if (gameConfig.level == 1) {
    ...
    var gameBG = createSprite(
      'images/ridder/RidderGameBG2.png',
      -50,
      -2,
      gameLoader
    )
...
function ridderGameOver() {
  ...
  gameConfig.shootBtn.interactive =
    gameConfig.rightBtn.interactive =
    gameConfig.leftBtn.interactive =
    gameConfig.upBtn.interactive =
    gameConfig.downBtn.interactive =
      false
...
function restartRidderGame() {
  ...
  var ridderGameBG = createSprite(
    'images/ridder/RidderGameBG1.png',
    -50,
    -2,
    gameLoader
  )
  ...
  if (localTest) {
    loadAppleResources({
      speak_b_apple_done: {
        ...
        subtitle:
          'Sikke en masse god juice du fik lavet! Men du tabte tre \u00e6bler p\u00e5 jorden. Du kan pr\u00f8ve igen, hvis du gerne vil tjene flere penge! Har du penge nok, kan du rejse en tur med Tidsmaskinen. Det kan ogs\u00e5 v\u00e6re, at der er kommet nogle flere ting i Karens butik, du kunne t\u00e6nke dig?',
      },
      speak_b_apple_done_no_money: {
        contenttype: 'sound',
        content: 'dk_afslutning_game_over_no_apples.mp3',
        subtitle:
          'Du tabte tre \u00e6bler p\u00e5 jorden. Du kan pr\u00f8ve igen, hvis du gerne vil tjene flere penge! Har du penge nok, kan du rejse en tur med Tidsmaskinen. Det kan ogs\u00e5 v\u00e6re, at der er kommet nogle flere ting i Karens butik, du kunne t\u00e6nke dig?',
      },
...
function loadAppleResources(data) {
  ...
  gameLoader.add('images/applegame/mobileRightBtn.png').load(initAppleGame)
}

function initAppleGame(loader, resources) {
  gameConfig = {}
  var appleBG = createSprite(
    'images/applegame/Baggrund.png',
    -120,
    -290,
    gameLoader
  )
  ...
  var appleFG = createSprite(
    'images/applegame/forground.png',
    -320,
    -125,
    gameLoader
  )
  ...
  var applePoints = createSprite(
    'images/applegame/Bundbar_aaben_extension.png',
    90,
    508,
    gameLoader
  )
  ...
  applePoints = createSprite(
    'images/applegame/Bundbar_aaben.png',
    185,
    516,
    gameLoader
  )
  ...
  gameConfig.scoreForApplesArray = new Array(
    [234, 576],
    [259, 586],
    [285, 594],
    [312, 601],
  ...
  for (var i = 0; i < 10; i++) {
    ...
    scoreApple = createMCGC(
      'Apple00',
      8,
      gameConfig.scoreForApplesArray[i][0],
      gameConfig.scoreForApplesArray[i][1]
    )
    if (isMobile || isIPad) {
  ...
  gameConfig.scoreAgainstApplesArray = new Array(
    [595, 582],
    [627, 572],
    [659, 562]
  )
  for (i = 0; i < 3; i++) {
    scoreApple = createMCGC(
      'Apple00',
      8,
      gameConfig.scoreAgainstApplesArray[i][0],
      gameConfig.scoreAgainstApplesArray[i][1]
    )
    if (isMobile || isIPad) {
      scoreApple.x = scoreApple.x - 50
    }
...
function showAppleIntro() {
  ...
  var introBG = createSprite(
    'images/applegame/Start_aeble.png',
    0,
    0,
    gameLoader
  )
...
function initAppleMobileControls() {
  if (gameConfig.mobileLeftBtn) {
    ...
    gameConfig.mobileLeftBtn = createSprite(
      'images/applegame/mobileLeftBtn.png',
      50,
      630,
      gameLoader
    )
    ...
    gameConfig.mobileRightBtn = createSprite(
      'images/applegame/mobileRightBtn.png',
      184,
      630,
      gameLoader
    )
...
function placeApple() {
  var apple = createMCGC(
    'Apple00',
    8,
    100 + Math.floor(Math.random() * 824),
    20 + Math.floor(Math.random() * 220)
  )
...
function startAppleFall() {
  var randomApple =
    gameConfig.apples[Math.floor(Math.random() * gameConfig.apples.length)]
...
function checkBasket(apple) {
  if (apple.y > 400) {
    if (
      gameConfig.character.x > apple.x - 60 &&
      gameConfig.character.x < apple.x + 60
    ) {
      //in basket
...
function appleGameCheckScore() {
  ...
  if (gameConfig.scoreAgainst >= 3) {
    ...
    var bg = createSprite(
      'images/applegame/gameover_lost_bg.png',
      0,
      0,
      gameLoader
    )
    ...
    //game won
    gameConfig.playingSound = playRandomSound([
      'speak_b_apple_nextlevel_1',
      'speak_b_apple_nextlevel_2',
      'speak_b_apple_nextlevel_3',
      'speak_b_apple_nextlevel_4',
  ...
  if (localTest) {
    loadPostResources({
      ...
      speak_postoffice_done: {
        ...
        subtitle:
          'Tusind tak for hj\u00e6lpen - det var du god til! Som tak for hj\u00e6lpen f\u00e5r du her nogle penge, som du kan bruge i Karens butik eller Tidsmaskinen. Du kan ogs\u00e5 hj\u00e6lpe mig igen, hvis du har lyst?',
      },
      postoffice_error: {
        contenttype: 'sound',
...
function loadPostResources(data) {
  ...
  gameLoader
    .add('images/postoffice/Rulle_hjul.png')
...
function initPostOffice(loader, resources) {
  var postBG = createSprite(
    'images/postoffice/background.png',
    80,
    0,
    gameLoader
  )
  ...
  for (var i = 0; i < 8; i++) {
    rulleHjul = createSprite(
      'images/postoffice/Rulle_hjul.png',
      478 - i * 60,
      512,
      gameLoader
    )
...
var packageItemsMedium = new Array(
  7,
  8,
  10,
  13,
...
var packageItemsDear = new Array(
  25,
  26,
  27,
  28,
...
function placePackages() {
  var item1index =
    packageItemsCheap[Math.floor(Math.random() * packageItemsCheap.length)]
  var item2index =
    packageItemsDear[Math.floor(Math.random() * packageItemsDear.length)]

  postGameTray1 = new PIXI.Container()
  postGameTray1.x = 190
  postGameTray1.y = 365
  var gameTrayHighlight = createSprite(
    'images/postoffice/trayHighlight.png',
    -8,
    58,
    gameLoader
  )
  ...
  postGameTray2.x = 340
  postGameTray2.y = 365
  gameTrayHighlight = createSprite(
    'images/postoffice/trayHighlight.png',
    -8,
    58,
    gameLoader
  ...
  if (postGameLevel >= 5) {
    item1index =
      packageItemsCheap[Math.floor(Math.random() * packageItemsCheap.length)]
    item2index =
      packageItemsMedium[Math.floor(Math.random() * packageItemsMedium.length)]
    item3index =
      packageItemsDear[Math.floor(Math.random() * packageItemsDear.length)]
...
function packageHover() {
  if (!this.dragging) {
    var paper = createSprite(
      'images/postoffice/PackagePapir.png',
      -50,
      -95,
      gameLoader
    )
...
function checkPostGameScore() {
  if (postGameLevel < 5) {
    if (
      postGameTray1.children[1].currentFrame != 0 &&
      postGameTray2.children[1].currentFrame != 7
    ) {
    ...
    if (
      postGameTray1.children[1].currentFrame != 0 &&
      postGameTray2.children[1].currentFrame != 7 &&
      postGameTray3.children[1].currentFrame != 14
    ) {
      //completed - do animate
      postGamePoints.gotoAndStop(postGameLevel)
      postGameLevel++
...
function showPostTruck() {
  ...
  if (postGameLevel == 2) {
    ...
    var truckBG = createSprite(
      'images/postoffice/gameover_BG.png',
      0,
      0,
      gameLoader
    )
...
function postTruckGone() {
  //ad next btn
  var gameOverBG = createSprite(
    'images/postoffice/gameover_BG2.png',
    0,
    0,
    gameLoader
  )
  ...
  if (localTest) {
    loadFarmResources({
      ...
      speak_b_farm_intro: {
        ...
        subtitle:
          'Velkommen til Bondeg\u00e5rden. Her skal du hj\u00e6lpe med at samle dyrene s\u00e5 de kan f\u00e5 noget at spise. F\u00f8rst skal du finde dyrene. Tr\u00e6k det rigtig antal dyr ind p\u00e5 midten af den store cirkel. Tryk p\u00e5 den gr\u00f8nne knap for at komme i gang.',
      },
      speak_farm_feed_cow: {
        contenttype: 'sound',
        content: 'farm_feed_cow_78.mp3',
        subtitle:
          'Nu er k\u00f8erne samlet og nu skal de have mad. Hver s\u00e6k giver mad til 1 ko. Hvor mange s\u00e6kke skal du bruge? Tryk p\u00e5 den gr\u00f8nne knap n\u00e5r du har trukket det rigtige antal s\u00e6kke ind i cirklen',
      },
      speak_farm_feed_duck: {
        contenttype: 'sound',
        content: 'farm_feed_ducks_67.mp3',
        subtitle:
          'S\u00e5 er det spisetid for \u00e6nderne. Hver s\u00e6k giver mad til 4 \u00e6nder, s\u00e5 hvor mange s\u00e6kke skal du nu bruge? Tryk p\u00e5 den gr\u00f8nne knap n\u00e5r du har trukket det rigtige antal s\u00e6kke ind i cirklen',
      },
      speak_farm_feed_horse: {
        contenttype: 'sound',
        content: 'farm_feed_horse_80.mp3',
        subtitle:
          'Nu skal hestene have mad. Hver s\u00e6k giver mad til 2 heste. Hvor mange s\u00e6kke skal du bruge? Tryk p\u00e5 den gr\u00f8nne knap n\u00e5r du har trukket det rigtige antal s\u00e6kke ind i cirklen',
      },
      speak_farm_feed_missing: {
        contenttype: 'sound',
        content: 'farm_feed_missing91.mp3',
        subtitle:
          'Der mangler nogle s\u00e6kke i cirklen. Hvor mange mangler der?',
      },
      speak_farm_feed_sheep: {
        contenttype: 'sound',
        content: 'farm_feed_sheep_81.mp3',
        subtitle:
          'Nu giver hver s\u00e6k mad til 3 f\u00e5r. Hvor mange s\u00e6kke skal du bruge? Tryk p\u00e5 den gr\u00f8nne knap n\u00e5r du har trukket det rigtige antal s\u00e6kke ind i cirklen',
      },
      speak_farm_feed_toomany: {
        contenttype: 'sound',
        content: 'farm_feed_toomany90.mp3',
        subtitle:
          'Der er vist lidt for mange s\u00e6kke i cirklen. Hvor mange skal du tr\u00e6kke ud?',
      },
      speak_farm_gather_cow: {
        contenttype: 'sound',
        content: 'farm_gather_cows.mp3',
        subtitle:
          'Du skal hj\u00e6lpe mig med at finde 12 k\u00f8er. Tr\u00e6k dem ind i den store cirkel!',
      },
      speak_farm_gather_duck: {
        contenttype: 'sound',
        content: 'farm_gather_ducks_83.mp3',
        subtitle:
          'Du klarer det rigtig godt! S\u00e5 er vi ved at v\u00e6re f\u00e6rdige. Som det sidste skal du finde 12 \u00e6nder. Kan du det?',
      },
      ...
      speak_farm_gather_sheep: {
        ...
        subtitle:
          'S\u00e5 er det f\u00e5rnes tur til at f\u00e5 mad. Kan du finde 12 f\u00e5r?',
      },
      speak_farm_gather_toomany: {
        contenttype: 'sound',
        content: 'farm_gather_toomany.mp3',
        subtitle:
          'Nu er der vist lidt for mange dyr i cirklen. Hvor mange skal du tr\u00e6kke ud?',
      },
      speak_farm_gold: {
        contenttype: 'sound',
        content: 'farm_gold_85.mp3',
        subtitle:
          'Det var du god til. Som tak for hj\u00e6lpen f\u00e5r du her 1 guldm\u00f8nt, som du kan bruge i Karens Butik eller i Tidsmakinen. Har du lyst til at hj\u00e6lpe mig en gang til?',
      },
      speak_farm_intro: {
        contenttype: 'sound',
...
function placeAnimal() {
  ...
  var animalShadowSprite = createSprite(
    'images/farm/animal-shadow.png',
    0,
    0,
    gameLoader
  )
...
function onAnimalDragStart(event) {
  ...
  if (this.children.length < 4) {
    playRandomSound([
      'farm_' + gameConfig.animalType + '1',
      'farm_' + gameConfig.animalType + '2',
      'farm_' + gameConfig.animalType + '3',
      'farm_' + gameConfig.animalType + '4',
    ])
...
function showHayIntro() {
  gameConfig.playingSound = playSound(
    'speak_farm_feed_' + gameConfig.animalType
  )
...
function addTroughHay() {
  ...
  if (gameConfig.farmLevel == 1) {
    hay = createMCGC(
      'troughHay00',
      4,
      130 + 65 * gameConfig.troughAnimIndex,
      176
    )
    hay.loop = false
    ...
    hay = createMCGC(
      'troughHay00',
      4,
      130 + 65 * gameConfig.troughAnimIndex * gameConfig.farmLevel,
      176
    )
    hay.loop = false
    gameConfig.hayGame.addChild(hay)
    ...
    hay = createMCGC(
      'troughHay00',
      4,
      130 + 65 * (gameConfig.troughAnimIndex * gameConfig.farmLevel + 1),
      176
    )
    hay.loop = false
    gameConfig.hayGame.addChild(hay)
    ...
    hay = createMCGC(
      'troughHay00',
      4,
      130 + 65 * (gameConfig.troughAnimIndex * gameConfig.farmLevel + 2),
      176
    )
    hay.loop = false
    gameConfig.hayGame.addChild(hay)
    ...
    hay = createMCGC(
      'troughHay00',
      4,
      130 + 65 * (gameConfig.troughAnimIndex * gameConfig.farmLevel + 3),
      176
    )
    hay.loop = false
    gameConfig.hayGame.addChild(hay)
...
function animalEat() {
  if (gameConfig.farmLevel == 1) {
    ...
    animal =
      gameConfig.hayAnimalArray[
        gameConfig.troughAnimIndex * gameConfig.farmLevel
      ]
    animal.gotoAndPlay(96)
    animal.onFrameChange = function () {
    ...
    animal =
      gameConfig.hayAnimalArray[
        gameConfig.troughAnimIndex * gameConfig.farmLevel + 1
      ]
    animal.gotoAndPlay(96)
    animal.onFrameChange = function () {
      if (this.currentFrame == 113) {
    ...
    animal =
      gameConfig.hayAnimalArray[
        gameConfig.troughAnimIndex * gameConfig.farmLevel + 2
      ]
    animal.gotoAndPlay(96)
    animal.onFrameChange = function () {
      if (this.currentFrame == 115) {
    ...
    animal =
      gameConfig.hayAnimalArray[
        gameConfig.troughAnimIndex * gameConfig.farmLevel + 3
      ]
    animal.gotoAndPlay(96)
    animal.onFrameChange = function () {
      if (this.currentFrame == 114) {
...
function loadWizardResources(data) {
  ...
  gameLoader
    .add('images/wizard/completedScene.png')
...
function initWizard(loader, resources) {
  ...
  var wizardBG = createSprite(
    'images/wizard/Skattekort.png',
    0,
    -40,
    gameLoader
  )
  ...
  if (user.visitedApple) {
    var place = createSprite(
      'images/wizard/Markering_aeble.png',
      280,
      130,
      gameLoader
    )
  ...
  if (user.visitedRoom) {
    place = createSprite(
      'images/wizard/Markering_hjem.png',
      274,
      243,
      gameLoader
    )
  ...
  if (user.visitedKaren) {
    place = createSprite(
      'images/wizard/Markering_karen.png',
      445,
      153,
      gameLoader
    )
  ...
  if (user.visitedGate) {
    place = createSprite(
      'images/wizard/Markering_port.png',
      433,
      433,
      gameLoader
    )
  ...
  if (user.visitedPost) {
    place = createSprite(
      'images/wizard/Markering_post.png',
      521,
      308,
      gameLoader
    )
  ...
  if (user.visitedTime) {
    place = createSprite(
      'images/wizard/Markering_tid.png',
      674,
      186,
      gameLoader
    )
...
function startWizardGame() {
  ...
  //setup elements
  gameConfig.wizardBG = createSprite(
    'images/wizard/QuizBg.png',
    285,
    110,
    gameLoader
  )
...
function wizardGameOver() {
  ...
  if (gameConfig.correctAnswers >= 8) {
    ...
    gameConfig.gameOverTitleTF = new PIXI.Text(
      wizardData.wizard_completed_header.content,
      wizardGameOverTitleStyle
    )
    ...
    gameConfig.gameOverBlob = createSprite(
      'images/wizard/completedScene.png',
      500,
      300,
      gameLoader
    )
    ...
    gameConfig.gameOverTextTF = new PIXI.Text(
      wizardData.wizard_secret_button.content,
      wizardGameOverTextStyle
    )
    ...
    //no win
    gameConfig.gameOverTitleTF = new PIXI.Text(
      wizardData.wizard_wrong_header.content,
      wizardGameOverTitleStyle
    )
    gameConfig.gameOverTitleTF.x = 320
    gameConfig.gameOverTitleTF.y = 200
...
function showTreasureMap() {
  ...
  var mapOverlay = createSprite(
    'images/wizard/KortOverlay.png',
    275,
    80,
    gameLoader
  )
...
function playWizard() {
  if (gameConfig.currentWizardSound) {
    if (gameConfig.currentWizardSound[1] == undefined) {
      ...
      gameConfig.wizardSound = playSound(
        gameConfig.currentWizardSound[0],
        gameConfig.currentWizardSound[1]
      )
    }
...
function startGate() {
  ...
  var penselClean = createSprite(
    'images/gate/pensel-clean.png',
    0,
    0,
    gameLoader
  )
...
function showMonopolyPopup() {
  ...
  var bubbleTF = new PIXI.Text(
    universeData.monopolyAccess_calc_text.content,
    monoBubbleStyle
  )
  bubbleTF.x = 40
  bubbleTF.y = 70
  ...
  $('#monoinput').css(
    'left',
    Math.floor((160 + offsetx + gamePopup.x) * mobileScale + gameContainer.x) +
      'px'
  )
  $('#monoinput').show()
...
function checkMonoAccess() {
  ...
  if (parseInt($('#monoinput input').val()) == gameConfig.correct) {
    ...
    gameConfig.wrongText = new PIXI.Text(
      universeData.monopolyAccess_wrong_body.content,
      monoWrongTextStyle
    )
...
function initMonopoly(loader, resources) {
  ...
  var monoIntroBG = createSprite(
    'images/monopoly/MonopolyIntroBG.png',
    0,
    0,
    gameLoader
  )
  ...
  var introBtn = createSprite(
    'images/monopoly/monoPlayGameBtn.png',
    700,
    460,
    gameLoader
  )
  ...
  if ($.isEmptyObject(user.mono)) {
    ...
    var introBtn = createSprite(
      'images/monopoly/monopolyGetSavedGame.png',
      840,
      360,
      gameLoader
    )
...
function monoSelectFamily() {
  ...
  gameConfig.startupBG = createSprite(
    'images/monopoly/MonopolyStartup.png',
    0,
    0,
    gameLoader
  )
  ...
  gameConfig.startupFamilyBG = createSprite(
    'images/monopoly/MonopolyStartupFamily.png',
    200,
    40,
    gameLoader
  )
  ...
  //show help text
  gameConfig.startupLeftText = new PIXI.Text(
    monoData.monopoly_startup_toolbar_family.content,
    smallTextStyle
  )
  ...
  var smallText = createSmallTextBold(
    monoData.monopoly_startup_family_label_adults.content,
    240,
    50
  )
  ...
  smallText = createSmallTextBold(
    monoData.monopoly_startup_family_label_children.content,
    710,
    150
  )
  gameContainer.addChild(smallText)
  ...
  frontGround.setChildIndex(
    frontGround.avatarBG,
    frontGround.children.length - 1
  )
  frontGround.setChildIndex(avatar, frontGround.children.length - 1)
  frontGround.setChildIndex(frontGround.logo, frontGround.children.length - 1)
...
function redrawPersons() {
  ...
  for (var i = 0; i < gameConfig.selectedChildren.length; i++) {
    person = createMCGC(
      'MonopolyFamilyMember00',
      34,
      100 + (i % 3) * 110,
      200 + 100 * Math.floor(i / 3)
    )
...
function monoCheckNames() {
  ...
  for (var i = 0; i < gameConfig.selectedAdults.length; i++) {
    if ($('#mononameinput' + i + ' input').val() == '') {
      ...
      gameConfig.selectedAdults[i].name = $(
        '#mononameinput' + i + ' input'
      ).val()
  ...
  for (var i = 0; i < gameConfig.selectedChildren.length; i++) {
    if ($('#mononameinput' + (i + 2) + ' input').val() == '') {
      ...
      gameConfig.selectedChildren[i].name = $(
        '#mononameinput' + (i + 2) + ' input'
      ).val()
      $('#mononameinput' + (i + 2) + ' input').css(
        'border',
        '1px solid #a9a9a9'
      )
    }
  ...
  if (namesSet) {
    if (
      gameConfig.selectedAdults.length > 0 &&
      gameConfig.selectedChildren.length > 0
    ) {
      $('.mononameinput').val('')
      $('.mononameinput').hide()
...
function monoSelectHouse() {
  if (
    gameConfig.selectedAdults.length >= 1 &&
    gameConfig.selectedChildren.length >= 1
  ) {
    ...
    //show help text
    gameConfig.startupLeftText.text =
      monoData.monopoly_startup_toolbar_items.content
    ...
    gameConfig.startupHouseBG = createSprite(
      'images/monopoly/MonopolyStartupItems.png',
      135,
      15,
      gameLoader
    )
...
function redrawExpences() {
  ...
  var label = new PIXI.Text(
    monoData.monopoly_startup_items_label_income.content,
    {
      fontFamily: 'Arial',
      fontSize: 16,
      fill: 'black',
  ...
  //total
  var label = new PIXI.Text(
    monoData.monopoly_startup_items_label_revenue.content,
    {
      fontFamily: 'Arial',
      fontSize: 16,
      fill: 'black',
...
function createPriceIcon(price, xPos, yPos) {
  ...
  icon.addChild(
    createSprite(
      'images/monopoly/MonopolyStartupExpencesIcon.png',
      15,
      0,
      gameLoader
    )
...
function monoInitGame() {
  if (
    ...
    gameConfig.money =
      80 -
      parseInt(gameConfig.userHousePrice) -
      parseInt(gameConfig.userPetPrice) -
      parseInt(gameConfig.userCarPrice)
    gameConfig.points = 0
    gameConfig.saved = 0
    ...
    gameConfig.monoGameFrontgroundBG = createSprite(
      'images/monopoly/monoToolbar.png',
      0,
      140,
      gameLoader
    )
...
function exitMono() {
  ...
  var exitBG = createSprite(
    'images/monopoly/MonopolySaveGamePopup.png',
    370,
    200,
    gameLoader
  )
  ...
  var saveBtn = createSprite(
    'images/monopoly/MonopolySaveGameButton.png',
    410,
    300,
    gameLoader
  )
  ...
  var cancelBtn = createSprite(
    'images/monopoly/MonopolyCancelGameButton.png',
    530,
    300,
    gameLoader
  )
...
function setupMonoBG() {
  ...
  var gameHouse = PIXI.Sprite.from(
    'images/monopoly/monoGameHouse00' + houseNumber + '.png'
  )
  gameHouse.x = 220
  gameHouse.y = 130
...
function startMonoMonth() {
  ...
  gameConfig.monthTimeOut = setTimeout(
    showEventStar,
...
function showCareBar() {
  ...
  var careBarBG = createSprite(
    'images/monopoly/monoBottomToolbar.png',
    0,
    0,
    gameLoader
  )
...
function monoSelectAlert() {
  ...
  if (gameConfig.eventData.consequence1title == '') {
    ...
    var eventBG = createSprite(
      'images/monopoly/monoEventFactBG.png',
      300,
      150,
      gameLoader
    )
    ...
    gameConfig.eventText = new PIXI.Text(
      getEventText('eventtext'),
      monoEventTextStyle
    )
    ...
    eventBG = createSprite(
      'images/monopoly/monoEventBG.png',
      180,
      130,
      gameLoader
    )
...
function monoAnswerClick() {
  ...
  //udfør konsekvens
  if (
    gameConfig.eventData['consequence' + (parseInt(this.name) + 1) + 'money'] ==
    ''
  ) {
    var price = 0
  } else {
  ...
  gameConfig.eventText.text = getEventText(
    'consequence' + (parseInt(this.name) + 1) + 'text'
  )
  ...
  if (gameConfig.money + price < 0) {
    ...
    var label = new PIXI.Text(
      monoData.monopoly_occ_status_eco_neg_balance.content,
      {
        fontFamily: 'Arial',
        fontSize: 12,
        fill: 'black',
    ...
    label = new PIXI.Text(
      monoData.monopoly_occ_status_eco_pos_balance.content,
      {
        fontFamily: 'Arial',
        fontSize: 12,
        fill: 'black',
  ...
  var resultTitle = new PIXI.Text(
    monoData.monopoly_occ_status_label.content,
    monoEventTextStyle
  )
  resultTitle.x = 350
  resultTitle.y = 340
...
function endMonth() {
  ...
  var endMonthBG = createSprite(
    'images/monopoly/monoBankBG.png',
    300,
    150,
    gameLoader
  )
  ...
  if (gameConfig.currentEventPrice < 0) {
    gameConfig.eventContainer.addChild(
      createMonoRow(
        'Overførsel',
        0,
        totalAmount + -1 * gameConfig.currentEventPrice,
        xPos,
        yPos
      )
    )
    ...
    gameConfig.eventContainer.addChild(
      createMonoRow(
        'Overførsel',
        0,
        totalAmount - gameConfig.currentEventPrice,
        xPos,
        yPos
      )
    )
  ...
  if (eventAmount >= 0) {
    gameConfig.eventContainer.addChild(
      createMonoRow(
        gameConfig.currentEventShortTitle,
        0,
        eventAmount,
        xPos,
        yPos
  ...
  if (gameConfig.petCare) {
    ...
    gameConfig.eventContainer.addChild(
      createMonoRow(
        monoData.monopoly_bank_transaction_petdoctor.content,
        1,
        1,
        xPos,
        yPos
    ...
    var petDocIcon = createSprite(
      'images/monopoly/monoBankPetDoctor.png',
      xPos - 220,
      yPos - 155,
      gameLoader
    )
  ...
  if (gameConfig.transportCare) {
    ...
    gameConfig.eventContainer.addChild(
      createMonoRow(
        monoData.monopoly_bank_transaction_mechanic.content,
        1,
        1,
        xPos,
        yPos
    ...
    var autoRepIcon = createSprite(
      'images/monopoly/monoBankMechanic.png',
      xPos - 220,
      yPos - 35,
      gameLoader
    )
  ...
  //subtotal
  gameConfig.eventContainer.addChild(
    createMonoRow('I alt', 2, totalAmount, xPos, yPos)
  )
  yPos += 50
  ...
  totalAmount += 80
  gameConfig.eventContainer.addChild(
    createMonoRow(monoData.monopoly_bank_income.content, 0, 80, xPos, yPos)
  )
  yPos += 25
  ...
  gameConfig.eventContainer.addChild(
    createMonoRow(
      monoData.monopoly_bank_transport.content,
      1,
      parseInt(gameConfig.userCarPrice),
      xPos,
      yPos
  ...
  gameConfig.eventContainer.addChild(
    createMonoRow(
      monoData.monopoly_bank_house.content,
      1,
      parseInt(gameConfig.userHousePrice),
      xPos,
      yPos
  ...
  gameConfig.eventContainer.addChild(
    createMonoRow(
      monoData.monopoly_bank_pet.content,
      1,
      parseInt(gameConfig.userPetPrice),
      xPos,
      yPos
  ...
  gameConfig.eventContainer.addChild(
    createMonoRow(
      monoData.monopoly_bank_equals.content,
      2,
      totalAmount,
      xPos,
      yPos
...
function showSavings() {
  ...
  var savingBG = createSprite(
    'images/monopoly/monoBankSaveBG.png',
    280,
    180,
    gameLoader
  )
...
function showNewYearsParty() {
  ...
  var nySprite = createSprite(
    'images/monopoly/ny/MonopolyNewYearBG.png',
    -80,
    -120,
    gameLoader
  )
  ...
  nySprite = createSprite(
    'images/monopoly/ny/MonopolyNewYearFrame.png',
    205,
    110,
    gameLoader
  )
  ...
  var nyItemPriceArray = new Array(
    200,
    30,
    10,
    1,
...
function buyNYItem() {
  ...
  for (i = 0; i < gameConfig.nyItemArray.length; i++) {
    if (gameConfig.nyItemArray[i] == 4) {
      var nyItemSprite = createSprite(
        'images/monopoly/ny/konfetti.png',
        203,
        110,
        gameLoader
      )
  ...
  for (i = 0; i < gameConfig.nyItemArray.length; i++) {
    if (gameConfig.nyItemArray[i] == 9) {
      nyItemSprite = createSprite(
        'images/monopoly/ny/Tallerkner.png',
        250,
        460,
        gameLoader
      )
  ...
  for (i = 0; i < gameConfig.nyItemArray.length; i++) {
    if (gameConfig.nyItemArray[i] == 8) {
      nyItemSprite = createSprite(
        'images/monopoly/ny/blomster.png',
        210,
        500,
        gameLoader
      )
  ...
  for (i = 0; i < gameConfig.nyItemArray.length; i++) {
    if (gameConfig.nyItemArray[i] == 10) {
      nyItemSprite = createSprite(
        'images/monopoly/ny/cerpentiner.png',
        210,
        110,
        gameLoader
      )
  ...
  for (i = 0; i < gameConfig.nyItemArray.length; i++) {
    if (gameConfig.nyItemArray[i] == 11) {
      nyItemSprite = createSprite(
        'images/monopoly/ny/Blomsterranker.png',
        210,
        110,
        gameLoader
      )
  ...
  for (i = 0; i < gameConfig.nyItemArray.length; i++) {
    if (gameConfig.nyItemArray[i] == 2) {
      nyItemSprite = createSprite(
        'images/monopoly/ny/Guirlander.png',
        200,
        110,
        gameLoader
      )
  ...
  for (i = 0; i < gameConfig.nyItemArray.length; i++) {
    if (gameConfig.nyItemArray[i] == 7) {
      nyItemSprite = createSprite(
        'images/monopoly/ny/Balloner.png',
        210,
        100,
        gameLoader
      )
...
function showMonoFinalScore() {
  ...
  var monoScoreSprite = createSprite(
    'images/monopoly/ny/MonopolyHighscoreYourScore.png',
    350,
    160,
    gameLoader
  )
  ...
  pointsTF = new PIXI.Text(
    monoData.monopoly_highscore_small_header.content + ' ' + gameConfig.points,
    {
      fontFamily: 'Arial',
      fontSize: 14,
      fill: 'black',
...
function showHoliday() {
  ...
  var holidayMapSprite = createSprite(
    'images/monopoly/sq/MonopolySQMap.png',
    75,
    6,
    gameLoader
  )
  ...
  var countrySprite = createSprite(
    'images/monopoly/sq/MonopolySQTravelButton.png',
    0,
    0,
    gameLoader
  )
...
function showHolidayQuiz() {
  ...
  var countryQBG = createSprite(
    'images/monopoly/sq/questionBG.png',
    200,
    150,
    gameLoader
  )
...
function sqAnswerClick() {
  ...
  if (this.index + 1 == correctOption) {
    ...
    gameConfig.eventText = new PIXI.Text(
      monoData.monopoly_summer_right_answer.content,
      monoEventTextStyle
    )
    gameConfig.eventText.x = 280
    gameConfig.eventText.y = 265
    ...
    gameConfig.eventText = new PIXI.Text(
      monoData.monopoly_summer_wrong_answer.content,
      monoEventTextStyle
    )
    gameConfig.eventText.x = 280
    gameConfig.eventText.y = 265
...
function sqGameOver() {
  ...
  gameConfig.eventText = new PIXI.Text(
    monoData.monopoly_summer_no_more_answers.content,
    monoEventTextStyle
  )
  gameConfig.eventText.x = 280
  gameConfig.eventText.y = 265
  ...
  var finishedIcon = createSprite(
    'images/monopoly/sq/sqFinishedIcon.png',
    280,
    310,
    gameLoader
  )
...
function createMonoAnswerBtn(index) {
  ...
  var txt = new PIXI.Text(
    getEventText('consequence' + (index + 1) + 'title'),
    monoBtnTextStyle
  )
  txt.x = 60
  txt.y = 15
...
function getEventText(field) {
  //consequence skal huske valgte name
  ...
  if (eventString.indexOf('<name>') == -1) {
    ...
    if (gameConfig.selectedNameEvent != '') {
      ...
      if (gameConfig.eventData.person == 'all') {
        if (Math.random() < 0.5) {
          var newName =
            gameConfig.selectedAdults[
              Math.floor(Math.random() * gameConfig.selectedAdults.length)
            ].name
        } else {
          newName =
            gameConfig.selectedChildren[
              Math.floor(Math.random() * gameConfig.selectedChildren.length)
            ].name
        }
...
function cleanup() {
  ...
  for (var i = cleanUpRemoveArray.length - 1; i >= 0; i--) {
    ...
    if (cleanUpRemoveArray[i].texture == null) {
    } else {
...
;(function (a) {
  ;(jQuery.browser = jQuery.browser || {}).mobile =
    /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|android|ipad|playbook|silk|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(
      a
    ) ||
